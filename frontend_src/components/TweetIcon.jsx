...
const animateIcon = (ComponentToAnimate) => (props) => {
  const { clickAnimation, ...other } = props;
...
const AnimatedReplyIcon = animateIcon(ReplyIcon);
...
const AnimatedRetweetIcon = animateIcon(RetweetIcon);
...
const AnimatedLikeIcon = animateIcon(LikeIcon);
...
const AnimatedShareIcon = animateIcon(ShareIcon);

export {
  ReplyIcon, AnimatedReplyIcon, ShareIcon, AnimatedShareIcon, LikeIcon, AnimatedLikeIcon,
  RetweetIcon, AnimatedRetweetIcon,
};
