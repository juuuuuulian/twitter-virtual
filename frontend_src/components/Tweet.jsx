...
const AnimatedTweetIcon = (props) => {
    const clickAnimation = props.clickAnimation;
    const clickHandler = (evt) => {
        let currentTarget = evt.currentTarget;
        let parent = currentTarget.parentElement; // apply animation to the parent - fix bug which displaces the hover state bg element
